...
** Org mode
   #+begin_src emacs-lisp
     ...
     ;;  (load-library "org")
     nnnn  ;;  (load-library "org-contacts")
     ;;  (load-library "org-macs")
     ;;  (load-library "org-src")
     ;;
     ...
     (setq ssmm-org-af '(""))
     (setq ssmm-org-af (append ssmm-org-af (split-string (f-read-text (concat ssmm-orgfiles-dir "org-agenda-files.txt")))))
     (setq ssmm-org-agenda-files (mapcar (lambda (f) (concat ssmm-orgfiles-dir f)) ssmm-org-af))
     ;; (setq ssmm-org-agenda-files (split-string (f-read-text (concat ssmm-orgfiles-dir "org-agenda-files.txt"))))
     (setq org-agenda-files ssmm-org-agenda-files)
